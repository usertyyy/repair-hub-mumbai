...
const FloatingButtons = () => (
  <>
    {/* WhatsApp floating */}
    <a href="https://wa.me/918282822265?text=Hi%2C%20I%20need%20repair%20service" target="_blank" rel="noopener noreferrer"
    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 flex md:hidden" style={{ background: "var(--cta-gradient)" }}>
      <a href="tel:+918282822265" className="flex flex-1 items-center justify-center gap-2 py-3.5 text-sm font-semibold text-primary-foreground">
