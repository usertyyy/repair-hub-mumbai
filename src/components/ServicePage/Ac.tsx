...
export default function ACRepairPage() {
  const [form, setForm] = useState({ name: "", phone: "", city: "", brand: "", acType: "", issue: "", slot: "" });
  ...
  return (
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: "#fff", color: "#111827" }}>
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr auto", gap: 40, alignItems: "center" }} className="hero-grid">
          <div>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 40 }}>
              <a href="#book" className="btn-primary">Book AC Repair <ArrowRight size={16} /></a>
      ...
      {/* FORM */}
      <section id="book" style={{ padding: "64px 20px", background: "#f0f9ff" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          <div className="sec-tag">Book a Repair</div>
          <h2 className="sec-h">Schedule Your AC Repair</h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={e => { e.preventDefault(); setSubmitted(true); }} style={{ background: "#fff", border: "1.5px solid #bae6fd", borderRadius: 10, padding: "28px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }} className="form-grid">
                ...
                <div>
                  <label className="field-label">AC Brand *</label>
                ...
                <div>
                  ...
                  <select className="field-input" value={form.acType} onChange={e => setForm({ ...form, acType: e.target.value })}>
