      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/60">
            <li className="flex items-start gap-2"><Phone className="h-4 w-4 mt-0.5 shrink-0" /> <a href="tel:+918282822265" className="hover:text-primary-foreground">+91 99999 99999</a></li>
